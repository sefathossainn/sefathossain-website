  ...
  blog: {
    ...
    fields: [
      ...
      { name: "excerpt", label: "Excerpt", type: "textarea", full: true },
      {
        ...
        type: "textarea",
        full: true,
        help: "Shown in the highlighted answer box at the top. Leave empty to use the excerpt.",
      },
      {
        name: "key_takeaways",
        ...
        type: "lines",
        full: true,
        help: "Shown as a checklist near the top of the post. Leave empty to hide.",
      },
