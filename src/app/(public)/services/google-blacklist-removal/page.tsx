...
const PATH = "/services/google-blacklist-removal";
const CRUMBS = [
  { name: "Home", path: "/" },
  { name: "Services", path: "/services" },
  { name: "Google Blacklist Removal", path: PATH },
];
  ...
  return (
    <main>
      <JsonLd
        data={[
          serviceSchema({
            name: "Google Blacklist Removal for WordPress",
            description: metadata.description as string,
            path: "/services/google-blacklist-removal",
            serviceType: "Google blacklist removal",
          }),
          faqPageSchema(faqs),
          breadcrumbSchema(CRUMBS),
          howToSchema({
            name: "How Google blacklist removal works",
            description: metadata.description as string,
            steps: process,
            path: PATH,
          }),
